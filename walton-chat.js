...
(function() {
  ...
  var PAGES = [
    ...
    { title:'Buying Guides',         url: base+'learn.html',
      tags:['learn','guide','buying guide','how to choose','which trailer','help me choose'] },
  ...
  var FAQS = [
    ...
    { tags:['gooseneck vs bumper','bumper pull','difference between','which type','hitch type'],
      ...
      link:{ text:'Read the Buying Guide', url: base+'learn.html' } },
    ...
    { tags:['landscape trailer','lawn trailer','mpr','mpr205','mpr207','lawn care trailer','landscaping trailer'],
    ...
    { tags:['dump trailer','dho210','dho212','dho215','dhv207','dhv208','hydraulic hoist','dump body','dumping trailer'],
    ...
    { tags:['tilt trailer','tsx207','tsx208','tsx307','tmx107','tilt equipment','tilt deck','full tilt','equipment loading'],
    ...
    { tags:['gooseneck','fbh207','fbh208','fbh210','fbh307','fbx210','fbx212','fbx215','flatbed gooseneck','gooseneck flatbed','heavy hauling'],
    ...
    { tags:['owner manual','user manual','owners manual','manual download','pdf manual','operator manual'],
      ...
      link:{ text:'Go to Owner Support', url: base+'owners.html#owners' } },
    { tags:['warranty claim','file warranty','submit warranty','how to claim warranty','warranty process'],
      ...
      link:{ text:'Submit Warranty Claim', url: base+'owners.html#warranty' } },
    { tags:['register trailer','how to register','trailer registration','register my trailer'],
      ...
      link:{ text:'Register Your Trailer', url: base+'owners.html#register' } },
  ...
  function respondAI(input, callback) {
    ...
    .then(function(data) {
      var reply = (data && data.reply) ? data.reply : respondLocal(input);
